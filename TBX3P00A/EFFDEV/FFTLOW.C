...
/* data[] is an array of length 2*n, used a real array of               */
...
/************************************************************************/
void FAR PASCAL EffFFTRea (float FAR *data, unsigned short n, short isign)
{
...
// MST        for (i=0; i <(int)(2*n); i+=2) {    /* Normalize                */
// MST            real[i] *= 2;
// MST            imag[i] *= 2;
// MST        }
    }
