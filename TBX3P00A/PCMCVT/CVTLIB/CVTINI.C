/************************************************************************/
/* Conversion Utility Initialization: CvtIni.c          V2.00  08/15/95 */
...
{
    _fmemset (lpCvtBlk, 0, sizeof (*lpCvtBlk));
    return (0);
}

WORD FAR PASCAL CvtCfgLod (LPSTR szCfgFil, VISMEMHDL FAR *pmhCfgMem)
{
    LPVOID       lpCfgBuf;
...
WORD FAR PASCAL CvtCfgRel (VISMEMHDL FAR *pmhCfgMem)
{
    return (((VISMEMHDL) NULL) != (*pmhCfgMem = GloAloRel (*pmhCfgMem)));
}

DWORD FAR PASCAL CvtCapQry (PCMTYP usPCMTyp, DWORD ulCapTyp, DWORD ulRsv001)
{
...
/************************************************************************/
/************************************************************************/
WORD    FAR PASCAL CvtSetDeb (WORD usDebFlg)
{
...
LPVOID  FAR PASCAL CvtSetDsp (MSGDSPPRC lpMsgDsp)
{
